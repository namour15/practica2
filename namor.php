...
if (isset($_POST['submit'])) {
    ...
    $from = "analaura_namour@hotmail.com"; // Email con el dominio del Hosting para evitar SPAM
    $fromName = "RPF-WEB"; // Nombre que saldrá en el email recibido
    $to = "analaura_namour@hotmail.com"; // Dirección donde se enviará el formulario
